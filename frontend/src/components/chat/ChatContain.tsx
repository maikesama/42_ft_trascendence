...
export const ChatContain = (props: any) => {
    ...
    const changeChat = (param: React.SetStateAction<string>, name: React.SetStateAction<string>, img: React.SetStateAction<string>, idIntra: React.SetStateAction<string>) => {
    ...
    function renderFriendRow(props: any) {
        ...
        return (
            <ListItem button style={style} key={index} onClick={event => changeChat('DM', friends[index]?.userName, friends[index]?.img, friends[index]?.idIntra)}>
